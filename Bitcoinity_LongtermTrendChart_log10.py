...
ax.text(date_abs_year[lnr-1]+0.02,price_fit_low[lnr-1]*0.9,price_fit_low_end+' (daily growth:'+price_grow_fit_low_end+'%)',color='xkcd:violet',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[lnr-1]+0.02,price_fit_mid1[lnr-1]*0.9,price_fit_mid1_end,color='xkcd:blue',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[lnr-1]+0.02,price_fit_mid2[lnr-1]*0.9,price_fit_mid2_end,color='xkcd:turquoise',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[lnr-1]+0.02,price_fit_mid3[lnr-1]*0.9,price_fit_mid3_end,color='lime',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[lnr-1]+0.02,price_fit_mid4[lnr-1]*0.9,price_fit_mid4_end,color='lime',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[lnr-1]+0.02,price_fit_mid5[lnr-1]*0.9,price_fit_mid5_end,color='xkcd:lime',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[lnr-1]+0.02,price_fit_mid6[lnr-1]*0.9,price_fit_mid6_end,color='gold',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[lnr-1]+0.02,price_fit_mid7[lnr-1]*0.9,price_fit_mid7_end,color='xkcd:orange',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[lnr-1]+0.02,price_fit_up[lnr-1]*0.9,price_fit_up_end+' (daily growth:'+price_grow_fit_up_end+'%)',color='red',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
ax.text(date_abs_year[0]+0.02,ymax*0.6,'Last plot update: UTC '+str(datetime.now(timezone.utc)),color='black',fontname='DejaVu Sans',style='normal',weight='ultralight',size=2)
